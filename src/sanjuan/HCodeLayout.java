...
public final class HCodeLayout implements LayoutManager {
    ...
    private Hashtable<Component, String> codes;
    ...
    public HCodeLayout(String usual, int hgap, boolean debug) {
        ...
        this.usual = usual;
        this.hgap = hgap;
        this.codes = new Hashtable<Component, String>();
        this.debug = debug;
    }
    ...
    private StringBuffer getCode(Component c) {
        ...
        Vector<Character> soFar = new Vector<Character>();
    ...
    public void layoutContainer(Container parent) {
        boolean min;
        int width, exCount, expansion, h, v;
